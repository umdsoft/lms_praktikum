...
const createDars = async (id) => {
    router.push({ name: 'lesson-dars-create', params: { id: id } })
}
                ...
                <div class="overflow-x-auto bg-white sm:rounded-lg">
                    <div class="p-6 flex items-center justify-between mb-10">
                        ...
                        <div class="flex items-center gap-2">
                            <button class="bg-[#166199] rounded py-2.5 px-5 flex gap-1 items-center text-white" @click="createDars(id)">
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 ">
                        <thead class="text-base text-gray-700  text-center">
                            <tr>
                                ...
                                <th class="px-6 py-3">Davomiyligi</th>
                                <th class="px-6 py-3">Mavzu uchun testlar</th>
